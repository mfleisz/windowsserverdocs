...
| networkautodetect:i:value | Determines whether automatic network type detection is enabled | - 0: Use automatic network bandwidth detection</br> - 1: Don't use automatic network bandwidth detection | 0 | Yes |
